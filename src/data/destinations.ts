...
export const DESTINATIONS: PointOfInterest[] = [
  ...
  // ════════════════════════════════════════════════════════
  {
    ...
    icon: '🛎️',
    description: 'Visitor check-in, badges, and building information.',
  ...
  },
  {
    ...
    icon: '🏢',
    description: 'Compact meeting room for 8 people with AV equipment.',
  ...
  },
  {
    ...
    icon: '🏢',
    description: 'Spacious meeting room for 12 with video conferencing.',
  ...
  },
  {
    ...
    icon: '☕',
    description: 'Specialty coffee, fresh pastries, and healthy lunch options.',
  ...
  },
  {
    ...
    icon: '🚻',
    description: 'Accessible restrooms with baby changing station.',
  ...
  },
  {
    ...
    regionId: 'G_OFFICE',
    icon: '💻',
    description: 'Open-plan workspace for the engineering team (40 desks).',
  ...
  },
  {
    ...
    regionId: 'G_SERVER',
    icon: '🖥️',
    description: 'Climate-controlled server room. Restricted access.',
  ...
  },
  {
    ...
    regionId: 'G_ELEVATOR',
    icon: '🛗',
    description: 'Main elevator serving all 3 floors.',
  ...
  },
  {
    ...
    regionId: 'G_ELEVATOR',
    icon: '🪜',
    description: 'Stairwell connecting all 3 floors.',
  ...
  // ════════════════════════════════════════════════════════
  {
    ...
    icon: '🎤',
    description: 'Large auditorium-style conference hall (100 seats) with full AV.',
  ...
  {
    id: 'POI_F1_TRAINING',
    name: 'Skillforge Training Lab',
    category: 'meeting_room',
    position: { x: 27, y: 1.5 },
    floorId: 'FLOOR_1',
    regionId: 'F1_TRAINING',
    icon: '📚',
    description: 'Hands-on training room with 30 workstations.',
  ...
  },
  {
    ...
    icon: '🧘',
    description: 'Quiet space for meditation, yoga, and wellness breaks.',
  ...
  },
  {
    ...
    regionId: 'F1_LAB',
    icon: '💡',
    description: 'R&D workspace with prototyping tools and 3D printers.',
  ...
  },
  {
    ...
    icon: '🚻',
    description: 'Restrooms on the first floor.',
  ...
  },
  {
    ...
    icon: '🛗',
    description: 'Main elevator — connects Ground, 1st, and 2nd floors.',
  ...
  // ════════════════════════════════════════════════════════
  {
    ...
    icon: '🏛️',
    description: 'Premium boardroom with panoramic views and 24-seat table.',
  ...
  {
    id: 'POI_F2_CTO',
    name: 'CTO Office — Rafael Costa',
    category: 'office',
    position: { x: 42, y: 1.5 },
    floorId: 'FLOOR_2',
    regionId: 'F2_CTO',
    icon: '💼',
    description: 'Office of the Chief Technology Officer.',
  ...
  },
  {
    ...
    regionId: 'F2_LOUNGE',
    icon: '🌅',
    description: 'Premium lounge with bar, terrace, and panoramic city views.',
  ...
  },
  {
    ...
    icon: '🛗',
    description: 'Main elevator — connects all floors.',
